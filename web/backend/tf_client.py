...
annoy_index_path = str(pathlib.Path('./data/annoy_index/img_embedding.ann').resolve())
...
# TODO: should we have arg, `img_path: str`, like we do in notebooks?
def find_similar_images(num_results: int = 5):
    ...
    target_embedding = get_prediction(processed_image, args.server_address)
